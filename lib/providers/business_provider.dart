...
class BusinessNewsData {
  ...
  Future<List<News>> fetchNews(int page) async {
    ...
    final response = await http.get('https://newsapi.org/v2/everything?q=business&apiKey=b4e1f7a8e2d8452e84270587a9eddbc5&pageSize=10&page=$page');
    if (response.statusCode == 200) {
      print("BUSINESSDATA=> ::::: =>>  ${response.body}");
