...
class _SportsPageState extends State<SportsPage>with AutomaticKeepAliveClientMixin<SportsPage> {

  ScrollController controller  = ScrollController();
  bool isShowLoader = false;
  int page = 1;
  SportsNewsData sportsNewsData = SportsNewsData();
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Container(
        child:
        FutureBuilder(
          future: sportsNewsData.fetchNews(page),
